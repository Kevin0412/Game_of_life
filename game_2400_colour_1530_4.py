...
video = cv2.VideoWriter("game_colour_6.mp4", cv2.VideoWriter_fourcc('I', '4', '2', '0'), 8,(2160,2160))
'''h=open("game.csv")
H=h.read()
Hh=H.split("\n")
data=[]
...
for g in range(1,1171):
    ...
    if cv2.waitKey(1)&0xFF==27:
        break
cv2.imwrite("game_colour_7.bmp",imgo)
video.release()
